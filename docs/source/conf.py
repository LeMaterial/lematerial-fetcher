...
project = "material-fetcher"  # Project name
...
html_title = "material-fetcher"  # Title for the HTML output for the docs, typically the project's name
html_theme = "shibuya"
